...
const Sidebar: FC<SidebarProps> = () => {
    ...
    return <div className={` w-2/12 z-20 fixed left-0 top-0 h-screen pt-16 border-r border-gray-300`}>
        <div className={` p-5`}>
            <div className={`border-2 border-black rounded-lg font-bold py-3 bg-black text-white hover:bg-gray-700 transition  cursor-pointer`}>
                <Center>
